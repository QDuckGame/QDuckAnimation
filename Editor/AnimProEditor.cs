...
{
    [CustomEditor(typeof(AnimPro))]
    public class AnimProEditor : Editor
    {
        ...
        private SerializedProperty _inlineLayersProp;
        ...
        private void OnEnable()
        {
            ...
            _inlineLayersProp = _configWrapperProp.FindPropertyRelative("_inlineLayers");
            ...
            switch (configType)
            {
                case AnimConfigType.ScriptableObject:
                    EditorGUILayout.PropertyField(_scriptableConfigProp,
                        new GUIContent("Anim Pro Set Asset"));
                    break;

                case AnimConfigType.Inline:
                    EditorGUILayout.PropertyField(_inlineLayersProp,
                        new GUIContent("Inline Layers"), true);
                    break;
            }
